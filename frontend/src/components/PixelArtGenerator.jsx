  ...
  const styles = [
    {
      id: "8bit",
      name: "8-Bit Classic",
      description: "Retro NES-style pixel art",
    },
    { id: "16bit", name: "16-Bit", description: "SNES-era detailed sprites" },
    {
      id: "gameboy",
      name: "Game Boy",
      description: "Monochrome green palette",
    },
    {
      id: "modern",
      name: "Modern Pixel",
      description: "High-res pixel art style",
    },
  ];
                ...
                {uploadedImage && (
                  <div className="mt-4">
                    ...
                    <img
                      ...
                      alt="Preview"
                      className="mt-2 w-full h-auto rounded-lg border border-gray-600"
                    />
                  </div>
                )}
              </div>
